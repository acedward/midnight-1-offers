...
#     that refuses every client — a defect the 2.x sibling spent a build chasing.
...
celestia_defaults() {
  ...
  # the kernel's hosted-preview override, kept as a documented example in .env.example.
